/**
 * Timezone-safe date helper for frontend.
 * Never runs string dates through new Date() or UTC conversion that shifts calendar dates.
 */
...
export function formatDisplayDate(dateStr?: string | null): string {
  ...
  // Already formatted as "15 October 2026"
